...
def post_facebook_clean(state_name, post_date, caption, image_paths):
    """
    Facebook वर एरर १०० न येता थेट व सुरक्षितपणे फोटो पब्लिश करणे
    आणि Instagram साठी आवश्यक URLs मिळवणे.
    """
    uploaded = []
    ...
    for idx, img_path in enumerate(image_paths):
        ...
        if "id" in res:
            ...
            print(f"✅ FB Photo {idx + 1}/{total} Published: {res['id']}")
        else:
...
def post_instagram(caption, uploaded_media):
    ...
    # केस २: मल्टिपल पेजेस (१८ रो मुळे नेहमी १० च्या आत -> १ अखंड कॅरोसेल)
    else:
        print(f"🚀 Instagram वर सर्व {total_images} पेजेसचा १ अखंड कॅरोसेल ग्रुप तयार होत आहे...")
        child_ids = []
        ...
        if "id" in car_res:
            ...
            print(f"✅ Instagram Carousel Published ({len(child_ids)} पेजेस एकाच ग्रुपमध्ये): {pub_res}")
        else:
...
def main():
    ...
    print(f"🚀 State सुरू आहे: {state_name} ({len(pages)} पेजेस - 4:5 रेशो, १८ रो)")
